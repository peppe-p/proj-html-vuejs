...
vue__WEBPACK_IMPORTED_MODULE_1___default().component((_chenfengyuan_vue_countdown__WEBPACK_IMPORTED_MODULE_0___default().name), (_chenfengyuan_vue_countdown__WEBPACK_IMPORTED_MODULE_0___default()));
var app = new (vue__WEBPACK_IMPORTED_MODULE_1___default())({
  ...
  data: {
    ...
    speakers: [[{
      ...
      role: "S&P Analyzer",
      imgURL: "./dist/images/speaker-6.jpg"
    }, {
      name: "Janet Jones",
      role: "Newyork Post's GM",
      imgURL: "./dist/images/speaker-5.jpg"
    }, {
      name: "Michael Dover",
      role: "Starbuck's CEO",
      imgURL: "./dist/images/speaker-4.jpg"
    }, {
      name: "Angelina Holy",
      role: "Maxii's Manager",
      imgURL: "./dist/images/speaker-3.jpg"
    }], [{
      name: "David Polline",
      role: "Dev COP",
      imgURL: "./dist/images/speaker-7.jpg"
    }, {
      name: "Patricia Bella",
      role: "S&P Analyzer",
      imgURL: "./dist/images/speaker-8.jpg"
    }, {
      name: "Albert Badoski",
      role: "S&P Analyzer",
      imgURL: "./dist/images/speaker-2.jpg"
    }, {
      name: "Alex Kennedy",
      role: "S&P Analyzer",
      imgURL: "./dist/images/speaker-1.jpg"
    }]]
  },
  methods: {
    menuIndex: function menuIndex(x) {
      this.selectedPage = x;
    },
    setTab: function setTab(x) {
      this.tab_on = x;
    },
    pagePre: function pagePre() {
      this.speaker_page - 1;

      if (this.speaker_page == 0) {} else {
        this.speaker_page--;
      }
    },
    pageAfter: function pageAfter() {
      ...
      if (this.speaker_page == this.speakers.length - 1) {} else {
        this.speaker_page++;
      }
    }
  }
